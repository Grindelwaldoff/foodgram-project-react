...
DROP INDEX public.main_ingredients_name_f824a24f_like;
ALTER TABLE ONLY public.main_ingredients DROP CONSTRAINT main_ingredients_pkey;
ALTER TABLE ONLY public.main_ingredients DROP CONSTRAINT main_ingredients_name_key;
ALTER TABLE public.main_ingredients ALTER COLUMN id DROP DEFAULT;
DROP SEQUENCE public.main_ingredients_id_seq;
DROP TABLE public.main_ingredients;
